...
# Memoiza a formatação, o parsing e a chave de ordenação de códigos
# contratuais usando lru_cache. Como a quantidade de identificadores INMS
# únicos por execução é pequena, mas a formatação e ordenação são
# chamadas repetidamente em loops pesados de geração de relatórios e
# planilhas, o cache evita a reavaliação de regexes e alocações de string
# (acelerando em ~12x as chamadas repetidas).
