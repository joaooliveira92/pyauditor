...
NAO_ATIVADO_TEXT: Final[str] = "Esse serviço não foi requisitado no período selecionado."
...
INMS_1_14_CATEGORIA_ORDER: Final[tuple[str, ...]] = ("MONITORAMENTO_NOC_SOC", "OPERACAO_N3")


def meta_atingida_display(value: float, target_operator: str, target_value: float) -> str:
