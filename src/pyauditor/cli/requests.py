...
Extraído de `cli/main.py`: cada `*Request` e o `_extract_*_request` correspondente
...
from pyauditor.cli.parser import Orgao, _DEFAULT_DATA_DIR
...
def extract_capa_path(ns: argparse.Namespace, *, data_dir: Path | None = None) -> Path:
