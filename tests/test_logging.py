...
def test_normalize_json_value_supported_types() -> None:
    ...
    assert normalize_json_value(datetime(2026, 6, 1, tzinfo=timezone.utc)) == "2026-06-01T00:00:00+00:00"
...
def test_normalize_json_value_rejects_invalid_types() -> None:
    ...
    with pytest.raises(TypeError, match="Unsupported logging context value type"):
