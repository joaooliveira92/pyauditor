...
def test_load_rows_handles_ragged_rows_by_dropping_overflow(tmp_path: Path) -> None:
...
def test_read_raw_csv_normalizes_grupo_executor_header_alias(tmp_path: Path) -> None:
