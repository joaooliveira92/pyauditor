...
def test_load_categorias_grupo_executor_both_filters_rejected(
    tmp_path: Path,
) -> None:
    load_categorias.cache_clear()
    path = _write(
...
def test_load_categorias_grupo_executor_no_filter_rejected(
    tmp_path: Path,
) -> None:
    load_categorias.cache_clear()
    path = _write(
...
def test_load_categorias_malformed_yaml_raises_actionable_value_error(
    tmp_path: Path,
) -> None:
    load_categorias.cache_clear()
...
def test_real_categorias_yaml_loads_and_covers_expected_inms(
    orgao: str,
) -> None:
    load_categorias.cache_clear()
