...
def test_compute_stats_conta_dentro_fora_do_prazo() -> None:
    rows = [
        {"No prazo": "S", "DataHoraSolicitacao": "01/06/2026 08:00", "DataHoraFim": "01/06/2026 10:00"},
        {"No prazo": "N", "DataHoraSolicitacao": "02/06/2026 08:00", "DataHoraFim": "02/06/2026 12:00"},
    ]
    stats = compute_stats(rows, fieldnames=["No prazo", "DataHoraSolicitacao", "DataHoraFim"], accepted_ids=set())
...
def test_compute_stats_sem_coluna_no_prazo_nao_conta_dentro_fora() -> None:
    rows = [{"DataHoraSolicitacao": "01/06/2026 08:00", "DataHoraFim": "01/06/2026 10:00"}]
    stats = compute_stats(rows, fieldnames=["DataHoraSolicitacao", "DataHoraFim"], accepted_ids=set())
...
def test_compute_stats_ignora_linhas_nao_aprovadas_no_tempo_medio() -> None:
    ...
    only_second = [rows[1]]
    stats = compute_stats(only_second, fieldnames=["No prazo", "DataHoraSolicitacao", "DataHoraFim"], accepted_ids={id(rows[1])})
...
def test_nivel_accumulator_acumula_sem_prazo() -> None:
    ...
    acc = acc.add(Stats(linhas=1, dentro=None, fora=None, duracao_total_segundos=0.0, duracao_contagem=0))
