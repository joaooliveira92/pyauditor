...
def test_report_ready_requires_comum_and_orgao_capas_and_roms(
    tmp_path: Path,
) -> None:
    ...
    check = check_report_ready(
        '2026-06', 'MinC', comum, roms_dir, data_dir=tmp_path
    )
...
def test_consolidate_ready_requires_both_orgao_reports_and_roms(
    tmp_path: Path,
) -> None:
