...
def test_atomic_write_creates_the_file_with_the_written_content(
    tmp_path: Path,
) -> None:
...
def test_atomic_write_leaves_the_existing_file_untouched_on_failure(
    tmp_path: Path,
) -> None:
    path = tmp_path / 'out.txt'
...
def test_atomic_write_leaves_no_temp_file_behind_on_failure(
    tmp_path: Path,
) -> None:
    path = tmp_path / 'out.txt'
