...
from pyauditor.config.models import IndicatorConfig, SegmentedRatioAcceptanceExpected
...
def test_inms_1_2_matches_acceptance_test() -> None:
    ...
    for actual_category, expected_category in zip(categories, expected.categories, strict=True):
...
def test_segmented_ratio_penalty_sums_underperforming_categories(tmp_path: Path) -> None:
